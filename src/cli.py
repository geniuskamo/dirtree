...
def main():
    ...
    parser.add_argument(
        "-e", "--exclude", help="Comma-separated list of directories to exclude"
    )
    parser.add_argument(
        "-v", "--verbose", action="store_true", help="Enable verbose logging to console"
    )
    ...
    parser.add_argument(
        "--cache-size", type=int, default=1000, help="Size of the directory cache"
    )
